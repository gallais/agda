...
data Keyword
        ...
        | KwPostulate | KwMutual | KwAbstract | KwPrivate | KwInstance | KwCompile
        | KwOverlap
...
layoutKeywords =
    [ KwLet, KwWhere, KwDo, KwPostulate, KwMutual, KwAbstract, KwPrivate, KwInstance, KwCompile, KwMacro, KwPrimitive, KwField ]
