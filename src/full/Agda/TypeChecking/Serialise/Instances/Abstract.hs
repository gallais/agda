...
instance EmbPrj NameSpaceId where
  ...
  icod_ OutsideNS       = icodeN 4 OutsideNS
...
instance EmbPrj Access where
  ...
  icod_ OnlyQualified               = icodeN 2 OnlyQualified
  icod_ OutsideAccess               = icodeN 3 OutsideAccess
