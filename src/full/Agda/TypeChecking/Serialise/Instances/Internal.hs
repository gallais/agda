...
instance EmbPrj Defn where
  ...
  icod_ (Function z a b t c d e f g h i j k m) = icodeN 1 (\ z a b -> Function z a b t) z a b c d e f g h i j k m
  ...
  value = vcase valu where
    valu [0]                                        = valuN Axiom
    valu [1, z, a, b, c, d, e, f, g, h, i, j, k, m] = valuN (\ z a b -> Function z a b Nothing) z a b c d e f g h i j k m
